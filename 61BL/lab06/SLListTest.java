...
public class SLListTest {
    ...
    public void testReverse() {
        SLList test1 = SLList.of();
        SLList test2 = SLList.of(42);
        SLList test3 = SLList.of(1, 2, 3);
        SLList compare1 = SLList.of();
        SLList compare2 = SLList.of(42);
        SLList compare3 = SLList.of(3, 2, 1);

        test1.reverse();
        assertEquals(test1, compare1);

        test2.reverse();
        assertEquals(test2, compare2);

        test3.reverse();
        assertEquals(compare3, test3);
    }
}
