...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (args[0]) {
            case "story":
                writeStory(args);
                System.out.println(Utils.readContentsAsString(new File(".capers/story.txt")));
                break;
            case "dog":
                makeDog(args);
                break;
    ...
    public static void writeStory(String[] args) {
        ...
        try {
            ...
            Utils.writeContents(s, Utils.readContents(s), args[1], "\n");
        } catch (IOException e) {
        }
    }
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        // FIXME
        File s = new File(".capers/dogs/" + args[1]);
        if (!s.exists()) {
            exitWithError(String.format("There is no dog named %s exists. Unfortunate.", args[1]));
        }
