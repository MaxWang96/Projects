...
//            System.out.println(String.format("Running test: %d", j));
            Map<String, Double> params = testParams.get(j);
            Map<String, Object> actual = rasterer.processRequest(params, null);
            Map<String, Object> expected = expectedResults.get(j);
            String msg = "Your results did not match the expected results for input "
                    + mapToString(params) + ".\n";
//            checkParamsMap(msg, expected, actual);
        }
    ...
    public void testMap() {
        ...
        input.put("lrlon", -122.20908713544797);
        input.put("ullon", -122.3027284165759);
        input.put("w", 305.0);
        input.put("h", 300.0);
        input.put("ullat", 37.88708748276975);
        input.put("lrlat", 37.848731523430196);
        Map<String, Object> actual = rasterer.processRequest(input, null);
        System.out.println(mapToString(actual));
    }
